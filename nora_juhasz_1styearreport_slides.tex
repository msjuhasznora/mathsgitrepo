...
\begin{frame}{Outlook}
  ...
  \item Solutions for the new, two-dimensional merged system.
...
\begin{frame}{The courses attended at the University of L'Aquila}
  \begin{itemize}
  \item
    Numerical Analysis 2 - Prof. Guglielmi
  \item
    High Performance Parallel Computing - the course was taught by four professors. Prof. Protasov, Prof Shcherbatyy and Prof. Khapko described rather \textbf{theoretical topics}, while Prof. Pera was introducing the main concepts and first examples of parallel computing and \textbf{Fortran}.
  \end{itemize}
\end{frame}
...
\begin{frame}{The courses attended at GSSI}
  ...
  \begin{itemize}
  \item
    Introduction to Finite Elements Method - Prof. Boffi
  \item
    Decay property for hyperbolic systems with dissipation - Prof. Kawashima
  \item
    Advanced Topics on Numerical Methods - Prof. Guglielmi
  \item
    Introduction to the incompressible Navier-Stokes equation - Prof. Marcati  
  \end{itemize}
\end{frame}
...
\begin{frame}{Seminars, workshops, summer schools}
  ...
  \begin{itemize}
  \item
    PDEs Day, 21st March 2017
  \item
    School on Uncertainty Quantification for Hyperbolic Equations and Related Topics, 24th-28th April 2017
  \item
    CIME School 2017  - Mathematical Analysis of the Navier-Stokes Equations, Cetraro
  \end{itemize}
\end{frame}
