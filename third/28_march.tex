...
When they write, let's define $\eta, \theta, \Phi$ through $v$ and $T,$ what they mean is $\textcolor{bittersweet}{T}$ as \textcolor{ao}{$T_1$}, or in other words, what is present on the opposite side of $\partial_z p$ (see the calculation in Appendix A.)
