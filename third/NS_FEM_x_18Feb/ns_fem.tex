...
Why it is crucial to have the right choice of element structure: the Taylor-Hood elements satisfy the BBL condition (coercivity plus an inf-sup condition on the functions $a$ and $b,$ respectively) that guarantees the well-posedness of the saddle point problem that we have:
