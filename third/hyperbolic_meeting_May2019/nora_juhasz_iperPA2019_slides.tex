...
%%% TEXT: Our goal is to provide a rigorous analytical proof that this approximation is mathematically acceptable.
\begin{frame}
...
The key to the justification process is to take this phrase \textit{"we are considering a large-scale geophysical fluid on the surface of the Earth,"} and to include its meaning into the model in mathematical terms.
...
Before we do anything else: fix the coordinate system.
