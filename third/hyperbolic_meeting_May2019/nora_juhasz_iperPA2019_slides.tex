...
%%% TEXT: 1.) Before we do anything else: fix the coordinate system.
...
%%% 2.) In a way it is a more considerately chosen coordinate system.
...
\begin{itemize}
 ...
 \item and the result of Li and Titi (Journal de Mathématiques Pures et Appliquées, 2017) stating that in this case we have the strong convergence of the weak solution $u_3^\epsilon$ in $L^2 L^2$ to the strong solution of the primitive equations. 

\end{itemize}

Using the fact that the strong solution of the PE is a weak solution as well, we can take back the proof onto the track of weak solutions and use the strong convergence of $u_3^\epsilon$ --- this enables us to pass to the limit with the nonlinear term.
