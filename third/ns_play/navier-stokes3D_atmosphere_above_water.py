...
k = Constant(dt)
f = Constant((0, 0, 0))
theta = Constant((ocean_drag_x, ocean_drag_y, 0))
...
while eps > DOLFIN_EPS:
    ...
    ufile = File("results_atmosphere_above_water/resultsA" + str(timestamp) + "_mesh" + str(meshsize) + "_dt" + str(dt) + "_eps" + str(eps) + "ws" + str(ocean_drag_x) + "_" + str(ocean_drag_y) + "/velocity" + "_mesh" + str(meshsize) + "_dt" + str(dt) + "_eps" + str(eps) + "ws" + str(ocean_drag_x) + "_" + str(ocean_drag_y) + ".pvd")
    pfile = File("results_atmosphere_above_water/resultsA" + str(timestamp) + "_mesh" + str(meshsize) + "_dt" + str(dt) + "_eps" + str(eps) + "ws" + str(ocean_drag_x) + "_" + str(ocean_drag_y) + "/pressure" + "_mesh" + str(meshsize) + "_dt" + str(dt) + "_eps" + str(eps) + "ws" + str(ocean_drag_x) + "_" + str(ocean_drag_y) + ".pvd")
    values.append(eps)
