...
A local domain on the surface of the rotating Earth is often described by a Cartesian coordinate system where the $x, y, z$ axes represent the directions towards east, north, and upwards, respectively, as in this specific system the Coriolis force takes a simpler form. However, for modelling wind and pollution effects in the atmosphere there is another naturally distinctive, meteorologically meaningful viewpoint for fixing the orientation of the coordinate system: the introduction of downwind and crosswind, and to match the horizontal axes to these. In this paper we take this idea as a foundation, and we migrate the result of our previously stated weak convergence theorem to this more considerately chosen coordinate system. In other words, we view the atmosphere as a shallow domain, and we verify that the weak solutions of the mathematical equations of the polluted atmosphere converge to the hydrostatic limit model even under the analytical consequences by the altered velocity and concentration equations. As in this scenario the advection is dominant compared to diffusion effects along the $x$ axis, this approach brings the challenge of proving a weak convergence result for the product of the vertical velocity and the concentration, as in the energy inequality the $\partial_1 C$ term is replaced by $\epsilon \partial_1 C.$ This issue is overcome by the construction of new estimates obtained by multiplying the governing equations by higher order terms.
...
Additional $\epsilon.$, \ref{goyal2011mathematical} idea.

Modified boundary conditions.

The intuitive meaning of the concept of downwind and crosswind, and the velocity for this choice of coordinates.
