...
The course is intended to give an overview on shock capturing schemes for the numerical solution of systems of conservation and balance laws. The emphasis is on the construction of high order finite volume and finite difference schemes, which are based on the three main ingredients: numerical flux, high order non oscillatory reconstruction, and high order integration in time. The first part of the course illustrates some models in which the nonlinearity produces shocks that propagate in time. Simple three point schemes, such as upwind, Lax-Friedrichs, and Lax-Wendroff will be reviewed, and they behavior on linear equations and systems analyzed, before the illustration of more complex methods for the quasilinear systems. In several computer sessions, the step by step construction of the schemes will be illustrated, and the methods will be applied to concrete examples of physical interest. The last part of the course is devoted to systems with source term. Two particular cases will be addressed: the construction of schemes for systems with stiff source of relaxation type (Asymptotic Preserving schemes) and the construction of well-balanced schemes.
...
\1 Software packages such as Docker, Anaconda, FEniCS and Alberta have been installed
