...
\begin{frame}{Proof steps - Part 1}
  \begin{enumerate}
    ...
    \item Once we have boundedness, we have the weak convergence of the linear terms, while the weak convergence of the nonlinear terms not including the pollution term had been shown before by \cite{azerad2001mathematical}.
...
\bibliography{merged_U_C_eqs_report_slides}
