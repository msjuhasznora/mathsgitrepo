...
\begin{align} 
  &  (S^\epsilon, \tilde{C}) &\quad & \text{bounded in $L^2(0,T)$,}  \\ 
  & (\mathbf{M} \nabla C^\epsilon, \nabla \tilde{C}) \leq c \big \| \tilde{C} \big \| _{H^1} \big \| C^\epsilon \big \| _{H^1} &\quad & \text{bounded in $L^2(0,T)$,}  \\
