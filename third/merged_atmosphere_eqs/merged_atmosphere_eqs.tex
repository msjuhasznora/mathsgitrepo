...
\[ \label{spatialWeakForm} 1 = 1\]

Now we take a $\tilde{C} \in H^2_x$ test function in (\ref{spatialWeakForm}) and integrate over $(t, t+h),$ i. e. we have
...
To close the proof we apply the Holder inequality and obtain
...
\end{proof}
  ...
  As a conclusion, we have the weak convergence $\mathbf{u}^\epsilon C^\epsilon \rightharpoonup \mathbf{u} C$ of the nonlinear term. This, combined with the previously described linear terms, concludes the proof of the main theorem.}
