...
\begin{frame}
\changefontsizes{10pt}
We multiply the previous equation by $- \partial_{ii} C^\epsilon, i=1,2,3.$ \textit{Highlight}: separation to individual indices $i = 1,2,3$ --- we can not use a uniform approach. We get
%
\begin{equation} \nonumber
  \begin{split}
