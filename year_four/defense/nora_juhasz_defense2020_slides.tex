...
\begin{frame}
The proof is partly based on [C. Cao, J. Li, and E. S. Titi, 2014], but note that they use an $H^2$ initial data --- their system is very similar to ours (including an incomplete Laplacian).
