...
\begin{frame}
We use this theorem to verify the strong convergence of $u_3^\epsilon,$ keeping in mind that \textit{a)} our domain is non-periodic, \textit{b)} we do not assume zero-averaged functions, and \textit{c)} the Coriolis terms are incorporated to the model as well.
\end{frame}
