...
def plot_error_values(resultsfolder, problem_data):
    ...
    plt.xlabel("The nx parameter in mesh(nx, nx)")
    plt.ylabel("log(L2 error)")
    plt.title("Function: u1, problem id: " + str(problem_data.id))
    plt.savefig(resultsfolder + "log_errorvalues" + str(problem_data.id) + "/L2_u1__id" + str(problem_data.id) + ".png", bbox_inches='tight', pad_inches=0)
    plt.clf()

    plt.scatter(global_lists.nxvalues, global_lists.log_errorvalues_L2_u3, color = colorid)
    plt.xlabel("The nx parameter in mesh(nx, nx)")
    plt.ylabel("log(L2 error)")
    plt.title("Function: u3, problem id: " + str(problem_data.id))
    plt.savefig(resultsfolder + "log_errorvalues" + str(problem_data.id) + "/L2_u3__id" + str(problem_data.id) + ".png", bbox_inches='tight', pad_inches=0)
    plt.clf()

    plt.scatter(global_lists.nxvalues, global_lists.log_errorvalues_L2_p, color = colorid)
    plt.xlabel("The nx parameter in mesh(nx, nx)")
    plt.ylabel("log(L2 error)")
    plt.title("Function: p, problem id: " + str(problem_data.id))
    plt.savefig(resultsfolder + "log_errorvalues" + str(problem_data.id) + "/L2_p__id" + str(problem_data.id) + ".png", bbox_inches='tight', pad_inches=0)
    plt.clf()

    plt.scatter(global_lists.nxvalues, global_lists.log_errorvalues_L2_c, color = colorid)
    plt.xlabel("The nx parameter in mesh(nx, nx)")
    plt.ylabel("log(L2 error)")
    plt.title("Function: c, problem id: " + str(problem_data.id))
    plt.savefig(resultsfolder + "log_errorvalues" + str(problem_data.id) + "/L2_c__id" + str(problem_data.id) + ".png", bbox_inches='tight', pad_inches=0)
    plt.clf()
