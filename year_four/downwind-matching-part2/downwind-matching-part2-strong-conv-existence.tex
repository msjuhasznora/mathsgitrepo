...
\begin{equation}
  \begin{split}
    & \int_\Omega \abs{\Delta_H S} \abs{\Delta_H C} \\
    & \leq \norm{\Delta_H S}_2 \norm{\Delta_H C}_2 \leq \norm{\Delta_H S}_2^2 + \norm{\Delta_H C}_2^2.
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    ...
    & \leq \int_\Omega \abs{\int_{-h}^z \nabla_H (\nabla_H \cdot \partial_z v) \diff \xi} \abs{C_z} \abs{\nabla_H C_z} \\
    & \leq \int_\Omega \bigg (\int_{-h}^0 \abs{\nabla_H (\nabla_H \cdot \partial_z v)} \diff \xi \bigg ) \abs{C_z} \abs{\nabla_H C_z} \\
    & \leq \int_M \bigg (\int_{-h}^0 \abs{\nabla_H (\nabla_H \cdot \partial_z v)} \diff \xi \bigg )  \bigg ( \int_{-h}^0 \abs{C_z} \abs{\nabla_H C_z} \diff \xi \bigg ) \\
    & \leq \norm{\nabla_H (\nabla_H \cdot \partial_z v)}_2^{1/2} \norm{\nabla_H \nabla_H (\nabla_H \cdot \partial_z v)}_2^{1/2} \norm{C_z}_2^{1/2} \norm{\nabla_H C_z}_2^{1/2} \norm{\nabla_H C_z}_2 \\
    & + \norm{\nabla_H (\nabla_H \cdot \partial_z v)}_2 \norm{C_z}_2 \norm{\nabla_H C_z}_2 \\
    & \leq \norm{v}_{H^3}^{1/2} \norm{\nabla_H v}_{H^3}^{1/2} \norm{C_z}_2^{1/2} \norm{\nabla_H C_z}_2^{3/2} + \norm{v}_{H^3} \norm{C_z}_2 \norm{\nabla_H C_z}_2 \\
    & \leq \norm{v}_{H^3}^{1/2} \norm{\nabla_H v}_{H^3}^{1/2} \norm{C_z}_2^{1/2} \norm{\nabla_H C_z}_2^{3/2} + (\norm{v}_{H^3}^2 + 1) \norm{\nabla_H C_z}_2^2 \\
...
\begin{equation}
  \begin{split}
    ...
    & \leq \norm{\nabla_H \partial_z v}_6 \norm{\nabla_H C}_3 \norm{\nabla_H \partial_z C}_2 \\
    & \leq \norm{\nabla_H \partial_z v}_6 \norm{\nabla_H C}_{H^1} \norm{\nabla_H \partial_z C}_2 \\
    & \leq \norm{\nabla_H \partial_z v}_6 (\norm{\Delta_H C}_2 + \norm{\nabla_H \partial_z C}_2) \norm{\nabla_H \partial_z C}_2 \\
    & \leq \norm{\nabla_H \partial_z v}_{H^1} \norm{\Delta_H C}_2 \norm{\nabla_H \partial_z C}_2 + \norm{\nabla_H \partial_z v}_6 \norm{\nabla_H \partial_z C}_2^2 \\
    & \leq \norm{v}_{H^3} (\norm{\Delta_H C}_2^2 + \norm{\nabla_H \partial_z C}_2^2) + \norm{v}_{H^3} \norm{\nabla_H \partial_z C}_2^2
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    & \int_\Omega \abs{\partial_z v} \vert \nabla_H^2 C \vert \abs{\nabla_H \partial_z C} \\
    & \leq \norm{\partial_z v}_\infty \| \nabla_H^2 C \| _2 \norm{\nabla_H \partial_z C}_2 \\
    & \leq \norm{\partial_z v}_\infty (\| \nabla_H^2 C \| _2^2 + \norm{\nabla_H \partial_z C}_2^2 ) \\
    & \leq \norm{v}_{H^3} (\| \nabla_H^2 C \| _2^2 + \norm{\nabla_H \partial_z C}_2^2 ).
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    & \int_\Omega \abs{\nabla_H \partial_z S} \abs{\nabla_H \partial_z C} \\
    & \leq \norm{\nabla_H \partial_z S}_2 \norm{\nabla_H \partial_z C}_2 \leq \norm{\nabla_H \partial_z S}_2^2 + \norm{\nabla_H \partial_z C}_2^2
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    & \int_\Omega \bigg ( \int_{-h}^0 \abs{\nabla_H (\nabla_H \cdot v)} \diff z \bigg) \abs{\partial_z C} \abs{\nabla_H \partial_z \partial_z C} \\
    & \leq \int_M \bigg ( \int_{-h}^0 \abs{\nabla_H (\nabla_H \cdot v)} \diff z \bigg) \bigg ( \int_{-h}^0 \abs{\partial_z C} \abs{\nabla_H \partial_z \partial_z C} \diff z \bigg ) \\
    & \leq \norm{\nabla_H (\nabla_H \cdot v)}_2^{1/2} \norm{\Delta_H (\nabla_H \cdot v)}_2^{1/2} \norm{\partial_z C}_2^{1/2} \norm{\nabla_H \partial_z C}_2^{1/2} \norm{\nabla_H \partial_z \partial_z C}_2 \\
    & + \norm{\nabla_H (\nabla_H \cdot v)}_2 \norm{\partial_z C}_2 \norm{\nabla_H \partial_z \partial_z C}_2 \\
    & \leq \norm{\nabla_H (\nabla_H \cdot v)}_2 \norm{\Delta_H (\nabla_H \cdot v)}_2 \norm{\partial_z C}_2 \norm{\nabla_H \partial_z C}_2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2 \\
    & + \norm{\nabla_H (\nabla_H \cdot v)}_2^2 \norm{\partial_z C}_2^2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2 \\
    & \leq \norm{v}_{H^3}^2 \norm{\nabla_H \partial_z C}_2^2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2 \\
    & + \norm{v}_{H^2}^2 \norm{\nabla_H \partial_z C}_2^2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2 \\
    & \leq \norm{v}_{H^3}^2 \norm{\nabla_H \partial_z C}_2^2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    & \int_\Omega \abs{\nabla_H (\nabla_H \cdot v)} \abs{C} \abs{\nabla_H \partial_z \partial_z C} \\
    & \leq \norm{C}_\infty \norm{\nabla_H (\nabla_H \cdot v)}_2 \norm{\nabla_H \partial_z \partial_z C}_2 \\
    & \leq \norm{C}_\infty^2 \norm{v}_{H^2}^2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    & \int_\Omega \abs{\nabla_H \cdot v} \abs{\nabla_H C} \abs{\nabla_H \partial_z \partial_z C} \\
    & \leq \int_\Omega \abs{\int_{-h}^z \nabla_H \cdot \partial_z v \diff \xi} \abs{\nabla_H C} \abs{\nabla_H \partial_z \partial_z C} \\
    & \leq \int_\Omega \bigg ( \int_{-h}^0 \abs{ \nabla_H \cdot \partial_z v} \diff \xi \bigg ) \abs{\nabla_H C} \abs{\nabla_H \partial_z \partial_z C} \\
    & \leq \int_M \bigg ( \int_{-h}^0 \abs{ \nabla_H \cdot \partial_z v} \diff z \bigg ) \bigg ( \int_{-h}^0 \abs{\nabla_H C} \abs{\nabla_H \partial_z \partial_z C} \diff z \bigg ) \\
    & \leq \norm{ \nabla_H \cdot \partial_z v}_2^{1/2} \norm{ \Delta_H \cdot \partial_z v}_2^{1/2} \norm{C}_\infty^{1/2} \norm{\Delta_H C}_2^{1/2} \norm{\nabla_H \partial_z \partial_z C}_2 \\
    & + \norm{\nabla_H \cdot \partial_z v}_2 \norm{C}_2 \norm{\nabla_H \partial_z \partial_z C}_2 \\
    & \leq \norm{ \nabla_H \cdot \partial_z v}_2 \norm{ \Delta_H \cdot \partial_z v}_2 \norm{C}_\infty \norm{\Delta_H C}_2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2 \\
    & + \norm{\nabla_H \cdot \partial_z v}_2^2 \norm{C}_2^2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2 \\
    & \leq  \norm{v}_{H^3}^2 \norm{C}_\infty^2 + \norm{\Delta_H C}_2^2 + c(\text{LHS}) \norm{\nabla_H \partial_z \partial_z C}_2^2 + \norm{v}_{H^2}^2 \norm{\nabla_H C}_2^2
  \end{split}
\end{equation}

\end{enumerate}

Summing up the above estimates, we arrive to

\begin{equation}
  \begin{split}
    & \frac{1}{2} \frac{\norm{\Delta_H C}_2^2 + \norm{\nabla_H C_z}_2^2}{\diff t} + \frac{1}{R_3} (\norm{\Delta_H C_z}_2^2 + \norm{\nabla_H C_{zz}} ) \\
    & \leq \big ( 1 + \norm{v}_{H^3}^2 + \norm{v}_{H^3}^2 \norm{\nabla_H v}_{H^3}^2 + \norm{C}_\infty \big ) \times (\norm{\Delta_H C}_2^2 + \norm{\nabla_H \partial_z C}_2^2) \\
    & + \big ( \norm{v}_{H^3}^2 \norm{\nabla_H v}_{H^3}^2 \norm{C}_\infty^2 +  \norm{v}_{H^3}^2(1 + \norm{C}_\infty^2) + \norm{\Delta_H S}_2^2 + \norm{\nabla_H \partial_z}_2^2 \big)
  \end{split}
\end{equation}
