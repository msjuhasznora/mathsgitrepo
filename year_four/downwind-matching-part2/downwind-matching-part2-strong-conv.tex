...
Firstly, we already have Proposition 5.1 in Li-Titi, i.e. the $L^2$ boundedness of the velocities.

Secondly, the $L^2$ boundedness of the $(U^\epsilon, C^\epsilon)$ system follows from the Poincare inequality and the $H^1$ regularity that is shown in the following sections.

However, for completeness, we describe the proof of the $L^2$ boundedness for the concentration function.

Multiply \todo{add, write} the governing equation for $C^\epsilon$ by $C^\epsilon,$ integrate and estimate.
