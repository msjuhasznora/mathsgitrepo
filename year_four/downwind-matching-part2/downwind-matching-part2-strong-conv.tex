...
\[ \norm{C^\epsilon}_{L^\infty(0,T^\epsilon_*; H^1(\Omega))} \leq \epsilon C \exp{(C \sqrt{T^\epsilon_*} + C)} < \infty,\]
...
\begin{enumerate}
  ...
  \item for any given fix point in time $T$ we have that $c^\epsilon \to c$ in $L^\infty H^1$ with a rate of $\epsilon,$
