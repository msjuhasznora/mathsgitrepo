...
\textbf{Step 5: estimate for $I_5 (i).$}

\begin{equation}
  \begin{split}
    & - \int_\Omega S^\epsilon \partial_{ii} C^\epsilon = - \int_\Omega (s^\epsilon - s) \partial_{ii} C^\epsilon \\
    & = - \int_\Omega (\delta^\epsilon - \delta ) \star \varphi \cdot \partial_{ii} C^\epsilon \\
    ...
    & \leq \int_\Omega \bigg ( (\delta^\epsilon - \delta ) \star \partial_i \varphi \bigg ) ^2 \diff x + \norm{\nabla C^\epsilon}_2^2.
  \end{split}
\end{equation}

The $\norm{\nabla C^\epsilon}_2^2$ term is fine, the next step is to estimate

$$\int_\Omega \bigg ( \int_\Omega (\delta^\epsilon - \delta )(x-y) \partial_i \varphi (y) \diff y \bigg )^2 \diff x.$$
...
\[ \norm{C^\epsilon}_{L^\infty(0,T; H^1(\Omega))} + \norm{\nabla_d C^\epsilon}_{L^2(0,T; H^1(\Omega))} \leq \epsilon C \exp{(C \sqrt{T} + C)}.\]
...
\[ \norm{C^\epsilon}_{L^\infty(0,T^\epsilon_*; H^1(\Omega))} + \norm{\nabla_d C^\epsilon}_{L^2(0,T^\epsilon_*; H^1(\Omega))} \leq \epsilon C \exp{(C \sqrt{T^\epsilon_*} + C)} < \infty,\]
