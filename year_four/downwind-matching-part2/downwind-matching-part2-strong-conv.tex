...
\begin{equation}
  \begin{split}
    ...
    & \leq \int_\Omega \bigg( \partial_i \big ( (\delta^\epsilon - \delta ) \star \varphi \big ) \bigg ) ^2 \diff x + \int_\Omega (\partial_i C^\epsilon)^2 \diff x \\
    & \leq \int_\Omega \bigg ( (\delta^\epsilon - \delta ) \star \partial_i \varphi \bigg ) ^2 \diff x + \textcolor{orange}{\norm{\nabla C^\epsilon}_2^2}.
  \end{split}
\end{equation}

The $\norm{\nabla C^\epsilon}_2^2$ term is fine, the next step is to estimate the first term. We denote $\Phi = \partial_i \varphi \in C^\infty_0.$ 
...
\begin{equation}
  \begin{split}
    ...
    & + C \textcolor{blue}{\norm{u_H^\epsilon}_{H^3}} \norm{\nabla C^\epsilon}_2^2 + C \norm{u_H^\epsilon}_{H^3}^2 \norm{\nabla C^\epsilon}_2^2 + \textcolor{orange}{\norm{\nabla C^\epsilon}_2^2} \\
    & + \textcolor{green}{C \norm{U_H^\epsilon}_{H^3}^2} + \norm{c}_{H^2}^2 \norm{\nabla C^\epsilon}_2^2 \\
    & + \textcolor{green}{C \norm{U_H^\epsilon}_{H^3}^2 \norm{\nabla c}_2^2} \\
...
\[ \int_0^T \textcolor{blue}{\norm{U_H^\epsilon}_{H^3}} + \textcolor{blue}{\norm{u_H^\epsilon}_{H^3}} + \norm{U_H^\epsilon}_{H^3}^2 + C \norm{u_H^\epsilon}_{H^3}^2 + \norm{c}_{H^2}^2 + \textcolor{orange}{1} \diff \tau,\]

which can be estimated with

\begin{equation}
  \begin{split}
    & \int_0^T \norm{U_H^\epsilon}_{H^3} + \norm{u_H^\epsilon}_{H^3} \diff \tau + C + \textcolor{orange}{T} \\
    & \leq \int_0^T \norm{1 \cdot U_H^\epsilon}_{H^3} + \norm{1 \cdot u_H^\epsilon}_{H^3} \diff \tau + C + \textcolor{orange}{T}\\
    & \leq T^{1/2} \bigg (\int_0^T \norm{U_H^\epsilon}_{H^3}^2 \bigg )^{1/2} \diff \tau + T^{1/2} \bigg (\int_0^T \norm{u_H^\epsilon}_{H^3}^2 \bigg )^{1/2} \diff \tau + C + \textcolor{orange}{T}\\
    & \leq \sqrt{T} C + C + \textcolor{orange}{T}.
  \end{split}
\end{equation}
...
\begin{equation}
  \begin{split}
    ...
    & \leq (\epsilon C + \textcolor{orange}{C \epsilon^2 \cdot T}) \exp{(C \sqrt{T} + C + \textcolor{orange}{T})}.
  \end{split}
\end{equation}
...
\begin{equation}
  ...
  & \leq (\epsilon C + \textcolor{orange}{C \epsilon^2 \cdot T^\epsilon_*}) \exp{(C \sqrt{T^\epsilon_*} + C + \textcolor{orange}{T^\epsilon_*})} < \infty,
  \end{split}
\end{equation}
