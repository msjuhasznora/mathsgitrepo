...
$$ \frac{1}{2} \frac{\diff}{\diff t} \norm{\nabla C^\epsilon}^2_{L^2} \leq C_1 \norm{\nabla C^\epsilon}^2_{L^2} + C_2 \epsilon^2 (\norm{\nabla \Delta c}^2_2 + \norm{\Delta c}^2_{L^2}).$$

Applying the Gronwall inequality we \todo{we need $\int_0^t C_1 \leq C$ otherwise it probably won't work} get

$$ \sup_{0 \leq s \leq t}{\norm{\nabla C^\epsilon}^2_{L^2}} \leq C_2 \epsilon^2 \int_0^t (\norm{\nabla \Delta c}^2_2 + \norm{\Delta c}^2_{L^2}) \diff s \times \exp{\int_0^t C_1 \diff s} $$
