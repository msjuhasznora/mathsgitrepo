...
\subsection{Estimating $\nabla C^\epsilon$}
 ...
 It seems that whatever regularity we can show for $C^\epsilon$ here in this coordinate system, it will be based and built on the $\partial_t C^\epsilon$ term, because from the Laplacians we won't have a complete term as the $\epsilon$ multiplier is there.
