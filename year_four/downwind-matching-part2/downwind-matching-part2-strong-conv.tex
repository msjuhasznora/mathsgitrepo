...
\begin{enumerate}
  ...
  \item Using the divergence-free condition, we have 

$$ \int_\Omega U^\epsilon \nabla C^\epsilon \Delta C^\epsilon = - \int_\Omega U^\epsilon \Delta C^\epsilon \nabla C^\epsilon$$

and

$$ \int_\Omega u \nabla C^\epsilon \Delta C^\epsilon = - \int_\Omega u \Delta C^\epsilon \nabla C^\epsilon,$$

thus these terms are $0.$

  \item To estimate $\int_\Omega U^\epsilon \nabla c \Delta C^\epsilon = - \int_\Omega U^\epsilon \Delta c \nabla C^\epsilon,$ we use the Holder inequality with $\frac{1}{\infty} + \frac{1}{2} + \frac{1}{2} = 1,$ the triangle inequality, the Poincare inequality and the Young inequality, obtaining
