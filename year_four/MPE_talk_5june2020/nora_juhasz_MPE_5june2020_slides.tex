...
\begin{frame}{Example: disappearing dependencies}
...
\begin{frame}{Complete horizontal symmetry without the Coriolis term}

$$ \partial_t \textcolor{airforceblue}{u_1}^\epsilon + \mathbf{u}^\epsilon \cdot \nabla \textcolor{airforceblue}{u_1}^\epsilon -\Delta_\nu \textcolor{airforceblue}{u_1}^\epsilon + \partial_1 p^\epsilon = 0 \text{ in } \Omega \times (0,T) $$

$$ \partial_t \textcolor{asparagus}{u_2}^\epsilon + \mathbf{u}^\epsilon \cdot \nabla \textcolor{asparagus}{u_2}^\epsilon -\Delta_\nu \textcolor{asparagus}{u_2}^\epsilon + \partial_2 p^\epsilon = 0 \text{ in } \Omega \times (0,T) $$

$$ \textcolor{jasper}{\epsilon^2} \{  \partial_t u_3^\epsilon + \mathbf{u}^\epsilon \cdot \nabla u_3^\epsilon -\Delta_\nu u_3^{\epsilon} \} + \partial_3 p^\epsilon = 0 \text{ in } \Omega \times (0,T) $$
