...
The authors of the \cite{azerad2001mathematical} and \cite{li2019primitive} articles have proved both weak and strong convergence theorems showing that the solutions of the complete Navier-Stokes equations considered in a shallow domain are "close" to the solutions of the hydrostatic system. More formally, they showed that as the shallowness parameter $\epsilon$ goes to zero, the solutions of the full Navier-Stokes system in fact converge to the solutions of the hydrostatic system (this latter is heavily used in applications, and thus with this convergence result a mathematical validation is provided). These results do not consider pollution effects, and they are elaborated in the classical geophysical Cartesian coordinate system. The main novelties of our present work are \textit{a)} to provide a generalisation of these previously mentioned results translated to the atmosphere, extending the fluid velocity equations with an additional convection-diffusion equation representing pollutants in the atmosphere and \textit{b)} to verify these results in a mathematically more challenging coordinate system.
