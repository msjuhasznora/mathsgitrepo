...
Number: 1. As the paper has a section called Notations in the beginning dedicated only to clarify certain notations, and since the definition of $b$ is given there (Point \textit{n)}), we feel like it is possibly redundant to mention more about it at this point.
