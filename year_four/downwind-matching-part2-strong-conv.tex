...
\begin{equation}
  \begin{split}
    ...
    & \leq \zeta_1 \norm{\Delta C^\epsilon}_2^2 + \frac{1}{\zeta_1} \norm{\nabla V^\epsilon}_2 \norm{\Delta V^\epsilon}_2 \norm{\nabla C^\epsilon}_2 \norm{\Delta C^\epsilon}_2 \\
    & \leq \zeta_1 \norm{\Delta C^\epsilon}_2^2 + \frac{1}{\zeta_1} \big ( \frac{1}{2} \norm{\nabla V^\epsilon}^2_2 \norm{\Delta V^\epsilon}^2_2 + \frac{1}{2} \norm{\nabla C^\epsilon}^2_2 \norm{\Delta C^\epsilon}^2_2 \big ).
  \end{split}
\end{equation}
...
We also need to create bounds for the new Coriolis terms.

Estimates for the Coriolis terms (for the moment on paper)

Comment on the source term.

Connecting all this, we have the updated version of the inequality which was the inequality after (5.7) in Li-Titi.
