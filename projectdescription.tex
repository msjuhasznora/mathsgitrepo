...
\[ \rho_0 = \sum_{i =1}^{N} \rho_i, p = \sum_{i =1}^{N} p_i, (\bold{v}, \omega) = \sum_{i =1}^{N}\frac{\rho_i}{\rho_0} \bold{v_i}J_{zp} \]
...
\[ \rho_0 = \sum_{i =1}^{N} \rho_i, p = \sum_{i =1}^{N} p_i, (\bold{v}, w) = \sum_{i =1}^{N}\frac{\rho_i}{\rho_0} u_i \]
