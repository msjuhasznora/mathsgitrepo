...
The 3-dimensional equations of the atmosphere. Two horizontal dimensions, one vertical dimension (using the change of coordinates according to hydrostatic approximation, ie. $p$ instead of $z$), mass continuity, equation of state and amount of water. Equations from the Temam-Ziane article (p34). Variables: $(x,y,p)$.
