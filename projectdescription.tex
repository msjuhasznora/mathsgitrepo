...
The left-handside of the pollution equation will be expanded (todo). The right hand-side, $\omega_i$ can be written in a linear way, a combination of a production and absorption term, but not more generally unless we have only two species all together.
