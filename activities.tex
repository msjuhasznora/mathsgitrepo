...
The main topics covered by this class are systems of nonlinear equations, nonlinear optimization (constrained and unconstrained), numerical method for the Cauchy problem, and boundary value problems for ODEs.
...
The question is, how to generalize the Euler-method? We can do that through the extension of quadrature (Runge-Kutta methods) or through interpolation (multi-step method).
