...
Let's consider the following problem, also known as The Simplest Problem. We aim to minimize the function $J(x) = \int_{t_0}^{t_1}L(t,x,\dot{x})dt ,$ where $t \in (t_0,t_1)$ and $x \in C^1[t_0,t_1]$. The most important equation we need when discussing this problem is the Euler-Lagrange equation, \ref{eq:eulerlagrange}.
...
The next problem we considered throughout the course of this lectur was the following boundary value problem.
...
The approach we were introduced is the so-called "shooting method".
...
\subsubsection{Programming and using Caliban - Prof. Pera}
