Todo.
 ...
 On this: I use the exact same building block that is used to create the three dimensional space used for the test functions. But this space is the closure of a continuous one - that doesn't make it continuous. What we need is a finite L_inf norm and continuity in x_s for the test function.
 
 Question. Why the closure of C^inf is equal to that space which is basically H^1 ? Do all H^1 functions can be approximated by a C^inf function?
