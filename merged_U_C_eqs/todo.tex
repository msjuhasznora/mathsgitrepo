...
generalized model: update every part (wf, ieq, theorem) accordingly with the new theta part and the new part_2, part_3 C part.

remove epsilon from the test functions - for the velocity terms we do not have epsilon on the test function, it should be in the same style.

 just like the test function for the velocity comes from a space that is a closure of a continuous space, the concentration test function should come from a continuous one as well (!!!!!!!!) 

  \item add boundary conditions to the H and A set of equations and add that to the list in the main theorem
