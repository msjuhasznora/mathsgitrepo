...
\section{Rescaling}
  ...
  \subsection{Rescaling due to special choice of coordinate system}
...
\section{Energy inequality and a priori estimates}
  ...
  In order to use the energy inequality to extract a priori estimates, we need to know that the righthand side of the inequality is bounded. Since the $S$ source term is assumed to be as smooth as we need it to be, the only term we need to work further is $\int _ 0 ^ t \epsilon K_1 \langle \partial_1 C, C \rangle_{\Gamma_G} d \tau$.
