...
The dispersion of pollutants is commonly modeled by convection / advection - diffusion equation. The diffusion-reaction equation describing the pollutant chemicals in the air:
...
\begin{itemize}
  ...
  \item Making the model physically more precise, accurate, and adapted for near seaside conditions are the following. \textbf{Apply to generalizations: one, drop the $\epsilon$ from $K_1$, since it comes from a very specifically fixed coordinate choice, and two, add ocean. Prove for this version.}
