...
We use $\frac{1}{\Delta t} (U^n - U^{n-1}, \tilde{U})_H$ to approximate $(U, \frac{\diff}{\diff t} \tilde{U}),$ but note that we will have a minus sign difference from the original version, as seen in the above expression.
