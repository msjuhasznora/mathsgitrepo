...
The energy inequality (\ref{energyIEQ}) now takes the form
  ...
  \begin{prop}
    Let $u^\epsilon_1, u^\epsilon_2, u^\epsilon_3$ and $C^\epsilon$ be the weak solutions of the system (\ref{ANSC1}) - (\ref{ANSC5}) in the sense of Definition \ref{definitionanisotropicWF}, assuming that the boundary conditions (\ref{ANSC8}) hold. Then the sequences
