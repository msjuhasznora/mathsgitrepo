...
\begin{definition}
Given a source term $S$ in $L^2(\Omega),$ find $U = (\mathbf{v}, C) \in V,$ such that
...
where all the other operators are understood in a way where the time integration is included, as we mentioned before.
